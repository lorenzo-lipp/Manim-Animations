...
class PerimeterTwo(Scene):
    def construct(self):
        ...
        self.wait(2)
        self.play(TransformFromCopy(sizes[0][0:], sum_text[0][0:2]))
        self.wait(0.3)
        self.play(TransformFromCopy(sizes[1][0], sum_text[0][3]))
        self.wait(0.3)
        self.play(TransformFromCopy(sizes[2][0], sum_text[0][5]))
        self.wait(0.3)
        self.play(TransformFromCopy(sizes[3][0], sum_text[0][7]))
        self.wait(1)
        self.play(
