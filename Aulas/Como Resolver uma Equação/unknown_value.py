...
class UnknownValue(Scene):
    def construct(self):
        ...
        line_2 = Line(
            expression_2[1][3].get_corner(DL) + 0.1 * (LEFT + DOWN), 
            expression_2[1][3].get_corner(UR) + 0.1 * (UP + RIGHT), 
            color=LIGHT_RED_COLOR
        )
        ...
        self.wait(1)
        self.play(Transform(expression_1, expression_2))
        self.wait(1)
        self.play(
            Create(line_1),
            Create(line_2)
        ...
        self.play(
            Transform(expression_1, expression_3),
