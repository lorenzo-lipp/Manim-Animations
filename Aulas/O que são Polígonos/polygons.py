...
class Polygons(Scene):
    def construct(self):
        ...
        self.wait(1)
        self.play(AlmostFadeOut(shapes[1][1], shapes[2][0]))
        self.wait(0.5)
        ...
        self.wait(1)
        self.play(AlmostFadeOut(shapes[0][0], shapes[3][0]))
        self.wait(0.5)
