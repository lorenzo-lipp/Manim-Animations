...
class NonTriangles(Scene):
    def construct(self):
        ...
        self.play(open_fig[2].animate.rotate(5 * DEGREES, about_point=open_fig[2].get_end()), run_time=0.7)
        self.wait(0.7)
        ...
        stroke_1 = VGroup(
            Line(triangle.points[0], triangle.points[3], color=LIGHT_BLUE_COLOR).scale(6),
        ...
        stroke_2 = VGroup(
            Line(triangle.points[3], triangle.points[7], color=LIGHT_RED_COLOR).scale(4),
        ...
        stroke_3 = VGroup(
            Line(triangle.points[7], triangle.points[11], color=LIGHT_PURPLE_COLOR).scale(6),
