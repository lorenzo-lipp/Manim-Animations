    ...
    def construct(self):
        ...
        self.play(
            LaggedStart(
                ...
                Transform(bananas[3], banana.copy().scale(0.8).next_to(kids[0], buff=3)),
                Transform(bananas[2], banana.copy().scale(0.8).next_to(kids[1], buff=1)),
                Transform(bananas[1], banana.copy().scale(0.8).next_to(kids[1], buff=2)),
                Transform(bananas[0], banana.copy().scale(0.8).next_to(kids[1], buff=3)),
                run_time=2.5,
                lag_ratio=0.5
            )
        )
